...
namespace PRO190726
{
    public partial class frmExpermentTH : Form
    {
        ...
        private void cbJsMode_Click(object sender, EventArgs e)
        {
        ...
        private void lbSave_Click(object sender, EventArgs e)
        {
            ...
            ProDefine.g_SMExpermentParam.ExpermentType = 1;
            ...
            ProDefine.g_SMExpermentParam.XNTHCS = txtXNTHCS.Text;
            ProDefine.g_SMExpermentParam.XNTHCS = txtTHYZ.Text;
