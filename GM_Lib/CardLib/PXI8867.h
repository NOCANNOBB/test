...
// AO 相关定义,通道个数2
// AO 停止模式
#define PXI8867_AO_CH0				(0)		// AO通道0
#define PXI8867_AO_CH1				(1)		// AO通道1
#define PXI8867_AO_CH11				(11)	// AO通道11
//////////////////////////////////////////////////////////////////////////
// 错误信息
...
extern "C" {
	...
	LONG __stdcall PXI8867_GetDevicePXISlot(				// 获得设备所在槽位
								HANDLE devHandle,
								ULONG* pxiSlotNum);
	//////////////////////////////////////////////////////////////////////////
	// AO 函数
	LONG __stdcall PXI8867_AO_InitChan(						// 初始化通道设置
								HANDLE devHandle, 			//
	...
	//------------------------------------------------------------------------
	// 校准函数
	LONG __stdcall PXI8867_AO_CalEn(				       // 校准函数
								HANDLE devHandle,
                                BOOL  bEn);                 // TRUE使能校准, FALSE 停止校准

    LONG __stdcall PXI8867_AO_Cal_Reset(					// 校准值复位
    ...
    LONG __stdcall PXI8867_AO_Cal_CalcWriteVal(				// 计算并写入校准值
								HANDLE devHandle,			// 设备句柄
								ULONG chanNum,				// 通道号
								double arrayCur[],			// 采集值
	...
	LONG __stdcall PXI8867_AO_Cal_WriteEEP(			    	// 写入EEP
								HANDLE devHandle);			// 设备句柄
	//////////////////////////////////////////////////////////////////////////
